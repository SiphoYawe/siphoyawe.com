...
export function Wordmark() {
  return (
    <h1
      ...
      className="relative z-10 w-screen max-w-none text-center font-display text-[clamp(3rem,16.4vw,20rem)] leading-[0.82] font-semibold tracking-[-0.03em] whitespace-nowrap text-sable select-none dark:text-paper"
    >
